...
@section('container')
    ...
    <div class="container mt-4" style="padding: 0 2rem">
        <div class="pagetitle">
            <h1>AI Image Baby Photo Settings</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                    <li class="breadcrumb-item active">Baby AI Settings</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <h5 class="card-title">Manage AI Image Baby Photo Settings</h5>
        ...
        <div class="modal fade" id="createModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <form action="{{ route('ai-image-baby-photo-setting.store') }}" method="POST" class="modal-content">
                    @csrf

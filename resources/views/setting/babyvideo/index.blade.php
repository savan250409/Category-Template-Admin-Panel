...
@section('title', 'AI Baby Video Module Settings')
@section('container')

    <div class="container mt-4" style="padding: 0 2rem">
        <div class="pagetitle">
            <h1>AI Baby Video Module Settings</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                    <li class="breadcrumb-item active">Baby Video Settings</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <h5 class="card-title">Manage AI Baby Video Module Settings</h5>
        ...
        <div class="modal fade" id="createModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <form action="{{ route('ai-baby-video-module-setting.store') }}" method="POST" class="modal-content">
                    @csrf
        ...
        <script>
            ...
            document.querySelectorAll('.editBtn').forEach(button => {
                button.addEventListener('click', function () {
                    ...
                    form.action = `/ai-baby-video-module-setting/${id}`;

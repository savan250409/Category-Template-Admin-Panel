    ...
    <div class="container mt-4 mb-5">
        <div class="page-header d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="page-subtitle">{{ isset($category) ? 'Update category details' : 'Create a new Filter AI Image category' }}
                </p>
            </div>
            <div>
        ...
        <div class="form-card">
            <form method="POST" enctype="multipart/form-data"
                action="{{ isset($category) ? route('filter-ai-image.categories.update', $category->id) : route('filter-ai-image.categories.store') }}"
                id="categoryForm">
                @csrf
                @if (isset($category))
                    @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <small class="text-muted" id="status-help">
                        Category status determines if it is visible in the mobile app.
                    </small>
                </div>

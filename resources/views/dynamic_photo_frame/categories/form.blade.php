...
@section('title', isset($category) ? 'Edit Dynamic Photo Frame Category' : 'Add Dynamic Photo Frame Category')
@section('container')
    <style>
    ...
    <div class="container mt-4 mb-5">
        ...
        <div class="form-card">
            <form method="POST"
                action="{{ isset($category) ? route('dynamic-photo-frame.categories.update', $category->id) : route('dynamic-photo-frame.categories.store') }}"
                ...
                <div class="mb-3">
                    ...
                    <div id="imagePreview" class="mt-2 {{ (isset($category) && $category->image) ? '' : 'd-none' }}">
                        <img id="previewImg"
                            src="{{ isset($category) && $category->image ? asset('upload/dynamic_photo_frame/' . $category->category_name . '/category image/' . $category->image) : '#' }}"

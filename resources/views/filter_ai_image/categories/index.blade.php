...
@section('title', 'Filter AI Image Category Management')
@section('container')
    <style>
        ...
        .data-table .col-status { width: 22%; }
        ...
        .category-image { width: 64px; height: 64px; object-fit: cover; border-radius: .35rem; border: 1px solid #eee; }
    ...
    <div class="container mt-4 mb-5">
        <div class="page-header d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="page-title"><i class="bi bi-tags me-2"></i>Filter AI Image Category Management</h1>
                <p class="page-subtitle">Manage all Filter AI Image categories in the system</p>
            </div>
            <div class="d-flex align-items-center gap-3">
                <span class="stats-badge">
                    <i class="bi bi-collection"></i> Total: <span id="totalCount">{{ $categories->total() }}</span> Categories
                </span>
                ...
                <a href="{{ route('filter-ai-image.categories.create') }}" class="btn btn-primary">
        ...
        <div class="main-card">
            ...
            <div id="ajax-container">
                @include('filter_ai_image.categories.table')
            </div>
        </div>
    </div>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.delete-btn', function () {
                ...
                Swal.fire({
                    ...
                    text: 'This will delete "' + name + '" and all its images and files.',
                    icon: 'warning',
            ...
            function loadCategories(page) {
                ...
                $.ajax({
                    url: "{{ route('filter-ai-image.categories.index') }}",
                    type: 'GET',
                    data: {
                        page: page || 1,
            ...
            $(document).on('change', '.status-toggle', function () {
                ...
                $.ajax({
                    url: "{{ route('filter-ai-image.categories.updateStatus') }}",
                    method: 'POST',
            ...
            function loadCategoriesForIndexing() {
                ...
                $.ajax({
                    url: "{{ route('filter-ai-image.categories.indexing') }}",
                    type: 'GET',
            ...
            document.getElementById('saveOrderBtn').addEventListener('click', function () {
                ...
                $.ajax({
                    url: "{{ route('filter-ai-image.categories.updateOrder') }}",
                    method: "POST",

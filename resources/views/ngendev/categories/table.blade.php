                ...
                <tr id="row-{{ $category->id }}">
                    ...
                    <td>
                        ...
                        @if (!empty($images) && isset($images[0]))
                            <img loading="lazy" decoding="async" src="{{ asset('upload/ngendev/images/' . rawurlencode($category->category_name) . '/category_thumbnail_image/' . rawurlencode($images[0])) }}" class="category-image">
                        @else

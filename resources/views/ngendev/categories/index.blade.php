        ...
        <div class="page-header d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="d-flex align-items-center bg-white p-2 rounded shadow-sm border">
                    <label class="form-check-label me-2 fw-bold small text-secondary" for="couple-status-toggle">Couple Status:</label>
                ...
                <a href="{{ route('ngendev.categories.create') }}" class="btn btn-primary">
            ...
            $('#couple-status-toggle').on('change', function () {
                ...
                $.ajax({
                    ...
                    error: function () {
                        ...
                        Swal.fire({ icon: 'error', title: 'Error', text: 'Failed to update global couple status' });
                    }
                });
            });
            ...
            $(document).on('change', '.type-select', function () {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.success) {
                            Swal.fire({ toast: true, position: 'top-end', icon: 'success', title: res.message, showConfirmButton: false, timer: 3000 });
                            loadCategories($('#ajax-container .pagination .page-item.active .page-link').data('page') || 1);
                        }
                    },
                    error: function () {
                        Swal.fire({ icon: 'error', title: 'Error', text: 'Failed to update type' });
                    }
                });
            });
        });
